sap.ui.define([
	"sap/ui/test/Opa5",
	"com/hariss/dpbs/DailyProductionBeverageSummaryFinal/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function(Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("com.hariss.dpbs.DailyProductionBeverageSummaryFinal.test.integration.arrangements.Startup", {
		...
		iStartMyApp : function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "com.hariss.dpbs.DailyProductionBeverageSummaryFinal",
					async: true
				},
				hash: oOptions.hash,
		...
		iRestartTheAppWithTheRememberedItem : function (oOptions) {
			...
			this.waitFor({
				success : function() {
					oOptions.hash = "PlantsSet/" + sObjectId;
